    ...
    <fieldset>
        ...
        <div class="conteneurDateHeure">
            <div>
                <span>
                    Du
                    <input required type="date" name="dateDebutRedaction" id="">
                </span>
                <span>
                    à
            ...
            <div>
                <span>
                    au
                    <input required type="date" name="dateFinRedaction" id="">
                </span>
                <span>
                    à
        ...
        <div class="conteneurDateHeure">
            <div>
                <span>
                    Du
                    <input required type="date" name="dateOuvertureVotes" id="">
                </span>
                <span>
                    à
            ...
            <div>
                <span>
                    au
                    <input required type="date" name="dateFermetureVotes" id="">
                </span>
                <span>
                    à
